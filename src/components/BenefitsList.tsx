...
const BenefitsList: React.FC<BenefitsListProps> = ({ compact = false }) => {
  ...
  const benefits = [
    { key: 'benefit1', text: t('login.benefit1') },
    { key: 'benefit2', text: t('login.benefit2') },
    { key: 'benefit3', text: t('login.benefit3') },
    { key: 'benefit4', text: t('login.benefit4') },
    { key: 'benefit5', text: t('login.benefit5') },
  ];
